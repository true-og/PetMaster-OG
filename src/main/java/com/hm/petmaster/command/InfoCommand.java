...
public class InfoCommand {
    ...
    public void getInfo(CommandSender sender) {
        ...
        templates.add(Placeholder.component("name", Component.text(plugin.getPluginMeta().getName())));
        templates.add(Placeholder.component("version", Component.text(plugin.getPluginMeta().getVersion())));
        templates.add(Placeholder.component("website", Component
                .text(plugin.getPluginMeta().getWebsite() != null ? plugin.getPluginMeta().getWebsite() : "")));
        ...
        plugin.getMessageSender().sendMessage(sender, "version-command-version",
                templates.toArray(new TagResolver[] {}));
        plugin.getMessageSender().sendMessage(sender, "version-command-website",
                templates.toArray(new TagResolver[] {}));
        plugin.getMessageSender().sendMessage(sender, "version-command-author",
                templates.toArray(new TagResolver[] {}));
        plugin.getMessageSender().sendMessage(sender, "version-command-description",
                templates.toArray(new TagResolver[] {}));
        plugin.getMessageSender().sendMessage(sender, "version-command-enabled",
                templates.toArray(new TagResolver[] {}));
